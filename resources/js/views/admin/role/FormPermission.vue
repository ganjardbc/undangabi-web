...
export default {
  ...
  methods: {
    ...
    async removeData() {
      ...
      const rest = await axios.post('/api/rolepermission/delete', payload, {
    ...
    async getData(id) {
      ...
      const rest = await axios.post('/api/rolepermission/getAll', payload, {
        headers: { Authorization: token },
      })
    ...
    async getPermission() {
      ...
      const rest = await axios.post('/api/permission/getAll', payload, {
        headers: { Authorization: token },
      })
