  ...
  <div id="App" :class="formClass ? 'content-form' : 'content-form hide'">
    <div class="left">
      <div class="bg-white shadow-sm">
        ...
        >
          <div>
            <h1 class="small text-black">TOPPINGS</h1>
        ...
        <div class="table-container">
          ...
          >
            <thead slot="head">
              ...
              <v-th sortKey="toping_id">toping ID</v-th>
...
export default {
  ...
  methods: {
    ...
    async removeData() {
      ...
      const rest = await axios.post('/api/toping/delete', payload, {
    ...
    async saveData() {
      ...
      const url =
        this.formTitle === 'CREATE' ? '/api/toping/post' : '/api/toping/update'
    ...
    async getData() {
      ...
      const rest = await axios.post('/api/toping/getAll', payload, {
        headers: { Authorization: token },
      })
