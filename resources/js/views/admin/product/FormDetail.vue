    ...
    >
      ...
      <div class="field-group margin margin-bottom-15-px">
        ...
        >
          {{
            formMessage &&
            formMessage.proddetail_id &&
            formMessage.proddetail_id[0]
          }}
        </div>
      </div>
      <div class="field-group margin margin-bottom-15-px">
...
export default {
  ...
  methods: {
    ...
    async removeData() {
      ...
      const rest = await axios.post('/api/productDetail/delete', payload, {
    ...
    async getData(id) {
      ...
      const rest = await axios.post('/api/productDetail/getAll', payload, {
        headers: { Authorization: token },
      })
