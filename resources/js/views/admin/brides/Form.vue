  ...
  <div id="form">
    ...
    >
      ...
      <div v-if="selectedIndex === 0">
        ...
        <div class="field-group margin margin-bottom-15-px">
          <div class="field-label">NICK NAME</div>
          <input
            type="text"
            placeholder=""
            class="field field-sekunder"
          ...
          >
            {{
              formMessage && formMessage.nick_name && formMessage.nick_name[0]
            }}
          </div>
        </div>
        <div class="field-group margin margin-bottom-15-px">
        ...
        <div class="field-group margin margin-bottom-15-px">
          <div class="field-label">INSTAGRM LINK</div>
          <input
            type="text"
            placeholder=""
            class="field field-sekunder"
    ...
    data: function (props, prevProps) {
      if (props) {
        this.formData = {
          ...this.formData,
          id: props.bride.id,
          bride_id: props.bride.bride_id,
          name: props.bride.name,
          nick_name: props.bride.nick_name,
          about: props.bride.about,
          parent: props.bride.parent,
          status: props.bride.status,
          instagram_link: props.bride.instagram_link,
          is_available: props.bride.is_available,
          invitation_id: props.bride.invitation_id,
        }
        this.image = props.bride.image
          ? this.brideImageThumbnailUrl + props.bride.image
          : ''
