  ...
  <div class="width w-full">
    ...
    >
      ...
      >
        ...
        >
          <div class="width w-[50px]">
            <div
              ...
              :style="`background-image: url(${loveStoryImageThumbnailUrl + dt.loveStory.image});`"
            >
              <i
                v-if="!dt.loveStory.image"
          ...
          <div
            :class="
              'card-capsule ' +
              (dt.loveStory.status === 'active' ? 'active' : '')
            "
        ...
        <div class="width w-full">
          <div class="text-[11px] font-semibold text-black margin margin-right-5px">
            {{ dt.loveStory.title }}
          </div>
          <div class="text-[10px] normal text-gray-500">
            {{ dt.loveStory.date | moment('D MMMM Y') }}
          </div>
          <div class="text-[10px] normal text-gray-500">
            {{ dt.loveStory.description }}
          </div>
        </div>
      </div>
        ...
        <el-popover placement="top-end" width="180" trigger="click">
          <div class="width w-full">
            <button
              ...
              @click="onUpdateCover(dt.loveStory)"
            >
              <i class="icn icn-left fa fa-lw fa-camera"></i> Ubah Cover
            </button>
            <button
              class="btn btn-white btn-full btn-align-left"
              @click="onEdit(dt.loveStory)"
            >
              <i class="icn icn-left fa fa-lw fa-edit"></i> Edit Data
            </button>
            <button
              class="btn btn-white btn-full btn-align-left"
              @click="onDelete(dt.loveStory)"
            >
