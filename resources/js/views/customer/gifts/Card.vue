      ...
      >
        ...
        >
          <div class="width w-[50px]">
            ...
            >
              <i
                v-if="!dt.comment.image"
                class="post-middle-absolute fa fa-lg fa-birthday-cake"
              ></i>
            </div>
          </div>
          <div
            :class="
              'card-capsule ' + (dt.comment.status === 'active' ? 'active' : '')
            "
