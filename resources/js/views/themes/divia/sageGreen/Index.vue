<template>
  <div id="App" class="theme">
    <div
      class="theme-header theme-header-second"
      id="divia-sage-green-theme-header"
    >
    ...
    <div class="theme-body" id="divia-sage-green-theme-bride">
      <div
            ...
            <div class="content-center" style="padding-bottom: 35px">
              ...
              >
                <a
                  ...
                  target="_blank"
                  class="btn btn-sekunder btn-small-radius divia-sage-green-button-date-content"
                >
                  <i
    ...
    <div
      ...
      id="divia-sage-green-theme-countdown"
    >
      <div class="theme-container">
        ...
        >
          <a
            ...
            target="_blank"
            class="btn btn-main divia-sage-green-button-date-content"
          >
    ...
    <div
      ...
      class="theme-body theme-container"
      style="padding-bottom: 50px"
      id="divia-sage-green-theme-ceremony"
    >
      <div class="theme-padding">
        <div style="text-align: center">
          <h2
    ...
    <div
      ...
      id="divia-sage-green-theme-moment"
    >
      <div class="theme-container">
        <div class="theme-padding">
          <div style="text-align: center">
    ...
    <div
      class="theme-body theme-container"
      style="padding-bottom: 60px"
      id="divia-sage-green-theme-guest"
    >
      <div class="theme-container">
        <div class="theme-padding">
          <div style="text-align: center">
    ...
    >
      ...
      <div class="theme-container-small display-flex center">
        <button
          class="btn btn-sekunder btn-small-radius divia-sage-green-button-date-content theme-invitation-animate"
          @click="visibleGifts = true"
        >
          Kirim Kado Digital
          <i class="icn icn-right fa fa-lw fa-birthday-cake"></i>
        </button>
      </div>
    </div>
    ...
    <AppPopupComponent
      ...
      @onClose="visibleGifts = false"
    >
      <AppCardDigitalGiftList :data.sync="dataGifts" :enableAnimation="true" />
    </AppPopupComponent>
    ...
    <div class="theme-navigation">
      <button
        ...
        @click="scrollToTarget('divia-sage-green-theme-header')"
      >
        <i class="fa fa-lg fa-user-friends" :style="`color: ${mainColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('divia-sage-green-theme-countdown')"
      >
        <i class="fa fa-lg fa-clock" :style="`color: ${mainColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('divia-sage-green-theme-ceremony')"
      >
      ...
      <button
        v-if="visibleGallery"
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('divia-sage-green-theme-moment')"
      >
        <i class="fa fa-lg fa-images" :style="`color: ${mainColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('divia-sage-green-theme-guest')"
      >
        <i
...
import AppCardDigitalGiftList from '../../../../components/modules/AppCardDigitalGiftList'
...
import AppPopupComponent from '../../../../components/modules/AppPopupComponent'
...
export default {
  ...
  methods: {
    closeGuestGreeting() {
      ...
      this.scrollToTarget('divia-sage-green-theme-header')
      this.playAudio()
    },
    playAudio() {
      this.audio.play()
