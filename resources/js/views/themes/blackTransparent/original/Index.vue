<template>
  <div
    id="App"
    class="theme theme-background-image"
    :style="`background-color: ${backgroundColor}; background-image: url(${selectedData.invitation.profile ? invitationImageCoverUrl + selectedData.invitation.profile : ''});`"
  >
    <div id="lavender-header" class="theme-header full">
      <div v-if="selectedData" class="theme-cover">
        ...
        <div
          ...
          "
        ></div>
        <div class="theme-transparent theme-inner-shadows">
          <div
                      ...
                      >
                        <div class="post-middle">
                          <div
                            ...
                            style="line-height: 1; margin-bottom: 10px"
                          >
                            {{ days }}
                          </div>
                          <div
    ...
    <div class="theme-body bg-transparent-40">
      ...
      >
                    ...
                    <div class="padding padding-15px">
                      ...
                      >
                        <a
                          ...
                          :style="`border-color: ${mainColor}; background-color: ${mainColor}; color: ${whiteColor};`"
                        >
        ...
        >
          <div class="width width-80px width-mobile">
            ...
            >
              <div
                class="fonts fonts-28 fonts-mobile-18 white white-mobile CormorantGaramondRegular weight-normal theme-invitation-animate"
    ...
    <div
      v-if="visibleEvent"
      class="theme-body bg-transparent-40"
    ...
    >
      ...
      >
        <a
          ...
          target="_blank"
          class="btn btn-main btn-small-radius fonts fonts-11 QuicksandRegular"
          :style="`border-color: ${blackColor}; background-color: ${blackColor}; color: ${whiteColor};`"
        >
    ...
    >
      <div class="theme-body">
        ...
        <div class="theme-padding">
          <AppGridGallery :disabledMargin="true" :data.sync="dataGalleries" />
        </div>
      </div>
    </div>
    ...
    <div v-if="visibleLoveStory" class="theme-body bg-transparent-40">
      <div class="theme-body theme-container">
        <div class="theme-padding" style="text-align: center">
          <div
            class="fonts fonts-24 fonts-mobile-20 white CormorantGaramondRegular weight-normal theme-invitation-animate"
      ...
      <div class="theme-body theme-container">
        ...
        <div class="theme-padding">
          <AppReservation
            ...
            :backgroundButtonColor="blackColor"
    ...
    <div
      ...
      :style="`background-color: ${mainColor}; z-index: 2;`"
    >
      <button
...
import AppPlaySong from '../../../modules/AppPlaySong'
