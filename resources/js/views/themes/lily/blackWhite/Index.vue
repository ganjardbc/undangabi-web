<template>
  ...
  >
    <div class="theme-header full" id="lily-theme-header">
      <div v-if="selectedData" class="theme-cover">
        ...
        <div class="post-middle-absolute content-center" style="width: 100%">
          <div
            class="fonts fonts-14 fonts-mobile-12 text-shadow theme-invitation-animate"
            :class="`${secondaryFont}`"
            style="color: #fff"
          >
          ...
          <h2
            class="fonts fonts-44 fonts-mobile-34 white weight-normal theme-invitation-animate"
            :class="`${primaryFont}`"
            style="color: #fff"
          >
          ...
          <div class="display-flex center theme-invitation-animate">
            ...
            >
              <button
                class="btn btn-main fonts fonts-11 fonts-mobile-10"
                :class="`${secondaryFont}`"
    ...
    >
      ...
      <div class="theme-body theme-container">
        <div class="theme-padding">
          <div style="text-align: center; padding-bottom: 20px">
            <h2
              class="fonts fonts-32 fonts-mobile-28 black weight-normal theme-invitation-animate"
              :class="`${primaryFont}`"
          ...
          <div class="theme-container-small" style="text-align: center">
            <div class="width width-100 width-mobile width-center">
              <div
                class="fonts fonts-14 fonts-mobile-12 black theme-invitation-animate"
                :class="`${secondaryFont}`"
            ...
            <div :class="'theme-bride ' + (i % 2 === 0 ? 'reverse' : '')">
              ...
              <div class="theme-bride-info">
                <div class="post-top post-mobile-none">
                  <h2
                    class="fonts fonts-32 fonts-mobile-24 black weight-normal theme-invitation-animate"
                    :class="`${primaryFont}`"
                    :style="`color: ${primaryColor};`"
                  >
                    {{ dt.bride.name }}
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                      class="btn btn-sekunder btn-small-radius fonts fonts-11 fonts-mobile-10"
                      :class="`${secondaryFont}`"
                      :style="`background-color: ${primaryColor}; border-color: ${primaryColor}; color: #fff;`"
                    >
                      <i
      ...
      <div v-if="visibleLoveStory" class="theme-body theme-container">
        <div class="theme-padding" style="padding-bottom: 0">
          <div class="theme-invitation-animate" style="text-align: center">
            <h2
              class="fonts fonts-32 fonts-mobile-28 black weight-normal"
              :class="`${primaryFont}`"
              :style="`color: ${primaryColor};`"
            >
              Our Love Stories
        ...
        <div class="theme-padding theme-container-small">
          <AppCardLoveStory
            ...
            :customMainFont="primaryFont"
            :customMainFontSize="'fonts-32 fonts-mobile-28'"
            :customPrimaryFont="secondaryFont"
      ...
      >
        <div class="theme-padding" style="padding-bottom: 0">
          <div class="theme-invitation-animate" style="text-align: center">
            <h2
              class="fonts fonts-32 fonts-mobile-28 white weight-normal"
              :class="`${primaryFont}`"
              :style="`color: ${primaryColor};`"
            >
              Wedding Events
      ...
      >
        <div class="theme-padding">
          ...
          >
            ...
            >
              <div
                class="fonts fonts-14 fonts-mobile-12 black"
                :class="`${secondaryFont}`"
              >
          ...
          <div class="theme-container-small">
            <AppCardDigitalGift
              :customButton="`fonts fonts-12 ${secondaryFont}`"
              :customMainFont="secondaryFont"
              :customBorderRadius="'12px'"
              :enableAnimation="true"
              :data.sync="dataGifts"
            />
        ...
        <div class="theme-container">
          <div class="theme-padding">
            <div class="theme-invitation-animate" style="text-align: center">
              ...
              <div
                class="fonts black theme-invitation-animate theme-font-content"
                :class="`${secondaryFont}`"
          ...
          <div class="theme-container-small" style="text-align: center">
            ...
            >
              ...
              <div style="padding-top: 10px">
                <h2
                  class="fonts fonts-44 fonts-mobile-34 black weight-normal theme-invitation-animate"
                  :class="`${primaryFont}`"
                  :style="`color: ${primaryColor};`"
                >
                  {{ selectedData.invitation.title }}
    ...
    <AppGustGreetings
      ...
      :customMainColor="primaryColor"
      :customMainFont="primaryFont"
      :customSecondaryFont="secondaryFont"
    ...
    >
      ...
      >
        <i class="fa fa-lg fa-images" :style="`color: ${tertiaryColor};`"></i>
      </button>
      <button
        v-if="visibleMap"
        class="btn btn-icon btn-sekunder btn-small-radius"
      ...
      >
        <i class="fa fa-lg fa-check" :style="`color: ${tertiaryColor};`"></i>
      </button>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      primaryFont: 'VisiaProBold',
      secondaryFont: 'QuicksandRegular',
      visibleGift: false,
