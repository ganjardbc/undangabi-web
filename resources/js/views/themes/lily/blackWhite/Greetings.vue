      ...
      <div class="theme-greeting-cover">
        <div class="theme-greeting-caption">
          <div class="theme-greeting-left">
            <div
              :class="`fonts fonts-14 fonts-mobile-12 white center capitalize normal ${customSecondaryFont ? customSecondaryFont : ''}`"
              :style="`color: #fff;`"
            >
              Wedding Invitation
            </div>
          ...
          <div class="theme-greeting-right">
            <button
              :class="`btn btn-main fonts fonts-11 fonts-mobile-10 ${customSecondaryFont ? customSecondaryFont : ''}`"
              @click="onClick"
