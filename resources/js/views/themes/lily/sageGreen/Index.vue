<template>
  ...
  >
                  ...
                  >
                    ...
                    >
                      <div class="post-middle">
                        <h2
                          class="fonts fonts-mobile-14 white RoxboroughCF"
    ...
    >
      ...
      <div class="theme-body theme-container">
        <div class="theme-padding">
          <div style="text-align: center; padding-bottom: 20px">
            <h2
              class="fonts fonts-32 fonts-mobile-28 white weight-normal CreattionDemo theme-invitation-animate"
            >
              We Found Love
            </h2>
          </div>
            ...
            <div :class="'theme-bride ' + (i % 2 === 0 ? 'reverse' : '')">
              ...
              <div class="theme-bride-info">
                <div class="post-top post-mobile-none">
                  <h2
                    class="fonts fonts-32 fonts-mobile-24 white weight-normal Lora theme-invitation-animate"
                  >
                    {{ dt.bride.name }}
                  </h2>
                  <div
      ...
      <div v-if="visibleLoveStory" class="theme-body">
      ...
      >
        <div class="theme-padding">
          ...
          >
            ...
            >
              <div class="fonts fonts-14 fonts-mobile-12 white VisiaPro">
    ...
    >
      ...
      >
        <i class="fa fa-lg fa-check" :style="`color: ${whiteColor};`"></i>
      </button>
    </div>
  </div>
</template>
