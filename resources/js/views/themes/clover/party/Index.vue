<template>
  <div id="App" class="theme" style="background-color: #fff">
    <div id="clover-event-theme-header" class="theme-body">
          ...
          <div v-if="selectedData" class="theme-cover" style="height: 100%">
            ...
            >
              <div style="margin-bottom: 18px">
                <div
                  class="fonts fonts-12 text-shadow semibold theme-invitation-animate"
                  style="color: #fff"
                >
                  ~ Undangan Acara ~
                </div>
                <h2
                  class="fonts fonts-28 black semibold DynaPuff theme-invitation-animate"
                  style="
                    color: #fff;
                    line-height: 1.3;
                    margin-top: 10px;
    ...
    <div
      id="clover-event-theme-bride"
      class="theme-body bg-image-bottom"
      style="
        background-image: url('/images/cloverEvent/bottom-content.png');
            ...
            <div class="theme-container-small" style="text-align: center">
              ...
              >
                <div style="padding-bottom: 20px">
                  <h2
                    class="fonts fonts-16 black semibold DynaPuff theme-invitation-animate"
                ...
                >
                  Kami mengundang Keluarga Hebat untuk hadir di acara “{{
                    generateTitle
                  }}” dan berkumpul bersama keluarga pasien pasca transplantasi
                  hati RSCM lainnya.​
                </div>
                <div class="fonts fonts-12 black theme-invitation-animate">
                  Kami berharap kegiatan ini bisa menjadi tempat saling mengenal
                  dan memberi dukungan antar keluarga pasien pasca transplantasi
                  hati RSCM.​
                </div>
              </div>
            </div>
        ...
        <div class="theme-padding display-flex display-mobile">
          ...
          >
            ...
            >
              ...
              <div
                class="fonts fonts-24 black semibold DynaPuff theme-invitation-animate"
    ...
    <div
      id="clover-event-theme-ceremony"
              ...
              >
                ...
                >
                  <div class="post-middle">
                    <h2
                      class="fonts fonts-28 black DynaPuff"
                      :style="`color: ${mainColor};`"
                    >
                      {{ days }}
                    </h2>
    ...
    <div class="theme-body">
      <AppImageBorder
        ...
        scaleX="1"
        customWidth="100%"
        customImageTopLeft="/images/cloverEvent/top-content.png"
      />
    </div>

    <div v-if="visibleEvent" class="theme-body">
      <div class="theme-padding theme-container">
        ...
        >
          <h2
            class="fonts fonts-16 black semibold DynaPuff"
            :style="`color: ${mainColor};`"
          >
        ...
        <AppCardEventTimeline
          ...
          :customMainFont="'DynaPuff'"
          :customBorderRadius="'12px'"
        />
      </div>
    </div>

    <div v-if="visibleMap" id="clover-event-theme-map">
      <div class="theme-body theme-container">
        <div class="theme-padding">
          <div
      ...
      <div class="theme-body theme-container">
        ...
        <div class="width width-full theme-invitation-animate-disable">
          <AppReservation
            ...
            :textButtonColor="'#fff'"
            :mainColor="mainColor"
            :title="'Yuk konfirmasi kehadiran Keluarga Hebat di sini​'"
            :labelCommentText="'Performance anak'"
            :descriptionCommentText="'Performance apa yang akan ditampilkan oleh anak? Yuk tulis di sini!​'"
            :descriptionAttendanceText="'Apakah Keluarga Hebat akan hadir di acara ini?'"
            :labelPresentText="'Berapa orang yang akan hadir?'"
            :descriptionPresentText="'Note: satu keluarga maksimal 3 orang'"
          />
        </div>
    ...
    <div class="theme-body">
      ...
      <AppImageBorder
        ...
        scaleX="1"
        customWidth="100%"
        customImageBottomRight="/images/cloverEvent/bottom-content.png"
      />
        ...
        <div class="theme-padding">
          <div class="theme-container-small" style="text-align: center">
            ...
            >
              ...
              >
                Kami sangat menantikan kehadiran Keluarga Hebat di acara ini.
    ...
    <AppGustGreetings
      ...
      :customButtonBackgroundColor="tertiaryColor"
      :customButtonTextColor="'#1A1507'"
      :customBackgroundColor="mainColor"
      :customMainColor="tertiaryColor"
    ...
    <div class="theme-navigation">
      <button
        ...
        @click="scrollToTarget('clover-event-theme-header')"
      >
        <i class="fa fa-lg fa-user-friends" :style="`color: ${mainColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('clover-event-theme-ceremony')"
      >
      ...
      <button
        v-if="visibleMap"
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('clover-event-theme-map')"
      >
        <i
      ...
      <button
        v-if="visibleGallery"
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('clover-event-theme-gallery')"
      >
        <i class="fa fa-lg fa-images" :style="`color: ${mainColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        @click="scrollToTarget('clover-event-theme-guest')"
      >
        <i
...
export default {
  ...
  methods: {
    closeGuestGreeting() {
      ...
      this.scrollToTarget('clover-event-theme-header')
      this.playAudio()
    },
    playAudio() {
      this.audio.play()
