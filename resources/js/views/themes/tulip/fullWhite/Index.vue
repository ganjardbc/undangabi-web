<template>
  <div id="App" class="theme" :style="`background-color: ${backgroundColor};`">
    <div
      class="theme-header theme-cover-flex border-bottom"
      id="lavender-header"
    ...
    >
      ...
      <div class="theme-single-caption">
        <div class="theme-container post-center-absolute">
          <div
            class="fonts fonts-14 fonts-mobile-12 black white-mobile Lora theme-invitation-animate"
            :style="`margin-bottom: 15px;`"
          >
            UNDANGAN PERNIKAHAN
          </div>
          <h1
            class="fonts fonts-42 fonts-mobile-34 weight-normal black white-mobile Gistesy theme-invitation-animate"
          ...
          <div v-if="guestName" style="margin-top: 15px">
            <div
              class="fonts fonts-14 fonts-mobile-12 black white-mobile Lora capitalize theme-invitation-animate margin margin-bottom-15px"
            >
              Kepada Yth, Bapak/Ibu/Saudara/i :
            </div>
            <div
              class="fonts fonts-18 fonts-mobile-16 black white-mobile Lora capitalize theme-invitation-animate"
            >
              {{ guestName }}
            </div>
            <div
              v-if="guestAddress"
              class="fonts fonts-14 fonts-mobile-12 black white-mobile Lora capitalize theme-invitation-animate"
            >
              {{ guestAddress }}
            </div>
          </div>
    ...
    <div class="theme-counter-container">
      <div class="theme-counter-content" id="lavender-countdown">
        <div
          class="theme-body theme-container border-full"
          :style="`background-color: ${mainColor}; padding-bottom: 50px;`"
        >
    ...
    <div class="theme-background-white" id="lavender-bride">
      <div v-for="(dt, i) in dataBrides" :key="i" class="width width-100">
        <div
          :class="`theme-header theme-cover-flex theme-cover-profile ${i % 2 === 0 ? 'row-reverse' : ''} border-bottom border-top`"
        >
          <div class="theme-cover-left"></div>
          <div class="theme-cover-right">
          ...
          <div class="theme-single-caption theme-single-position">
            <div class="theme-container theme-single-position-bottom-mobile">
              <h1
                class="fonts fonts-42 fonts-mobile-34 weight-normal black white-mobile Gistesy text-shadow-mobile theme-invitation-animate"
                :style="`color: ${primaryColor};`"
              >
                {{ dt.bride.name }}
              </h1>
    ...
    <div
      class="theme-background-white border-bottom border-top"
      :style="`background-color: ${mainColor};`"
      id="lavender-guest"
    >
      <div class="theme-body theme-container">
    ...
    <div class="theme-body width width-100 border-bottom">
      <AppImageBorder
