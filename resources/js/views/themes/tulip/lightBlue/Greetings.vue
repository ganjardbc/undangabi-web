      ...
      <div class="theme-greeting-cover">
        <div class="theme-greeting-caption">
          <div class="theme-greeting-left">
            <div
              class="fonts fonts-14 fonts-mobile-12 black center normal Lora margin margin-bottom-15px"
            >
              UNDANGAN PERNIKAHAN
            </div>
            <h1
              :class="`fonts fonts-42 fonts-mobile-34 black center weight-normal ${customMainFont ? customMainFont : ''}`"
            ...
            <div v-if="guestName" class="margin margin-top-15px">
              <div
                class="fonts fonts-14 fonts-mobile-12 black center capitalize normal Lora margin margin-bottom-15px"
              >
                Kepada Yth, Bapak/Ibu/Saudara/i :
              </div>
              <div
                class="fonts fonts-18 fonts-mobile-16 black center capitalize normal Lora"
              >
                {{ guestName }}
              </div>
              <div
                v-if="guestAddress"
                class="fonts fonts-14 fonts-mobile-12 black center capitalize normal Lora"
              >
                {{ guestAddress }}
              </div>
            </div>
          ...
          <div class="theme-greeting-right">
            <button
              ...
              :style="`background-color: ${customPrimaryColor ? customPrimaryColor : '#50607D'}; border-color: ${customPrimaryColor ? customPrimaryColor : '#50607D'}; color: #fff;`"
            >
              Lihat Undangan
