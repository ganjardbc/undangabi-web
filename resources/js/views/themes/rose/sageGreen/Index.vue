<template>
  <div id="App" class="theme">
      ...
      <div v-if="selectedData" class="theme-cover">
        ...
        <div class="post-middle-absolute content-center" style="width: 100%">
          <div>
            ...
            <h1
              class="fonts fonts-48 fonts-mobile-38 weight-normal CreattionDemo text-shadow theme-invitation-animate"
        ...
        >
          <div class="theme-padding">
            ...
            <div class="theme-container-small" style="text-align: center">
              ...
              >
                <div
                  class="fonts fonts-24 fonts-mobile-18 black CreattionDemo theme-invitation-animate"
          ...
          >
            <div style="width: 100%">
              ...
              >
                <div>
                  <h2
                    class="fonts fonts-32 fonts-mobile-28 black CreattionDemo weight-normal theme-invitation-animate"
                  >
                    {{ dt.bride.name }}
                  </h2>
                  <div
                ...
                >
                  <a
                    ...
                    target="_blank"
                    class="btn btn-sekunder btn-small-radius rose-sage-green-button-date-content fonts fonts-12 VisioPro"
                  >
    ...
    >
        ...
        <div class="theme-time">
          ...
          >
            <div class="post-middle">
              <h4
                class="fonts fonts-32 fonts-mobile-28 black ViaodaLibre"
                :style="`color: ${mainColor};`"
              >
                {{ days }}
              </h4>
          ...
          >
            <div class="post-middle">
              ...
              <p class="fonts fonts-14 fonts-mobile-12 grey VisiaPro">Menit</p>
            </div>
          </div>
          <div
            class="time-2 theme-invitation-animate"
          ...
          >
            <div class="post-middle">
              ...
              <p class="fonts fonts-14 fonts-mobile-12 grey VisiaPro">Detik</p>
            </div>
          </div>
        </div>
      </VueCountdown>
      ...
      >
        <a
          ...
          target="_blank"
          class="btn btn-main rose-sage-green-button-date-content fonts fonts-12 VisioPro"
        >
    ...
    <div v-if="visibleLoveStory" class="theme-body theme-container">
      <div class="theme-padding" style="padding-top: 0; padding-bottom: 0">
    ...
    <div v-if="visibleGallery" class="theme-body" id="rose-theme-moment">
    ...
    <div class="theme-body theme-container" id="rose-theme-guest">
      <div class="theme-padding" style="padding-bottom: 0">
        <div class="theme-invitation-animate">
          <AppBorderTop />
        </div>
        ...
        <div class="theme-container-small" style="text-align: center">
          ...
          <div class="width width-80 width-mobile width-center content-center">
            ...
            <div style="padding-top: 10px">
              <h2
                class="fonts fonts-48 fonts-mobile-38 weight-normal CreattionDemo theme-invitation-animate"
                :style="`color: ${mainColor};`"
                v-html="selectedData.invitation.title"
              />
            </div>
...
<style lang="scss">
.rose-sage-green-button-date {
  background-color: rgba($color: #000, $alpha: 0.5) !important;
  border-color: rgba($color: #000, $alpha: 0.5) !important;
  color: #aebea4 !important;
}
.rose-sage-green-button-date-reverse {
  background-color: #fff !important;
  border-color: #fff !important;
  color: #aebea4 !important;
}
.rose-sage-green-button-date-content {
  background-color: #aebea4 !important;
  border-color: #aebea4 !important;
  color: #fff !important;
}
</style>
