<template>
  ...
  >
    <div class="theme-body">
      <div class="theme-header full" id="traditional-blackgold-theme-header">
      ...
      <div
        id="traditional-blackgold-theme-bride"
        class="theme-body"
                ...
                >
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                      class="btn btn-sekunder btn-small-radius traditional-blackgold-button-date-content fonts fonts-12 VisiaPro"
                    >
      ...
      <div
        id="traditional-blackgold-theme-countdown"
      ...
      >
        ...
        >
          <a
            ...
            target="_blank"
            class="btn btn-main traditional-blackgold-button-date-reverse fonts fonts-12 VisiaPro"
          >
      ...
      <div
        v-if="visibleEvent"
        id="traditional-blackgold-theme-ceremony"
      ...
      <div
        v-if="visibleMap"
        id="traditional-blackgold-theme-map"
        class="theme-container"
      >
      ...
      <div
        v-if="visibleGallery"
        id="traditional-blackgold-theme-moment"
        class="theme-container"
      >
        <div class="theme-body theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
      ...
      <div
        id="traditional-blackgold-theme-guest"
        class="theme-body"
        :style="`background-color: ${mainColor};`"
      >
    ...
    >
      <button
        ...
        @click="scrollToTarget('traditional-blackgold-theme-header')"
      >
        <i
      ...
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-blackgold-theme-countdown')"
      >
      ...
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-blackgold-theme-ceremony')"
      >
        <i
      ...
      <button
        ...
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-blackgold-theme-map')"
      >
        <i
      ...
      <button
        ...
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-blackgold-theme-moment')"
      >
      ...
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-blackgold-theme-guest')"
      >
        <i
...
export default {
  ...
  methods: {
    closeGuestGreeting() {
      ...
      this.scrollToTarget('traditional-blackgold-theme-header')
      this.playAudio()
    },
    playAudio() {
      this.audio.play()
