...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/loveStory/getAll', params, {
    ...
    createData({ commit, state }, data) {
      ...
      return axios
        .post('/api/loveStory/post', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/loveStory/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/loveStory/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadCover({ commit, state }, data) {
      ...
      params.append('love_story_id', data.love_story_id)
      params.append('image', data.image)

      return axios
        .post('/api/loveStory/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
