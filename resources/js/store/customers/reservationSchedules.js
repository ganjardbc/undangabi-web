...
export default {
  ...
  mutations: {
    ...
    SET_FORM_DATA(state, value) {
      if (value) {
        ...
        state.form = {
          ...defaultPayload,
          reservation_schedule_id: `RS-${time}`,
          status: 'active',
        }
      }
    },
  ...
  actions: {
    ...
    getByID({ commit, state }, data) {
      ...
      return axios
        .post('/api/reservationSchedules/getByID', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const payload = res.data.data
    ...
    createData({ commit, state }, data) {
      ...
      return axios
        .post('/api/reservationSchedules/post', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/reservationSchedules/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/reservationSchedules/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
