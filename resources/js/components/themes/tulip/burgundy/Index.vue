    ...
    >
      ...
      <div class="theme-single-caption">
        <div class="theme-container post-center-absolute">
          <div
            class="fonts fonts-14 fonts-mobile-12 white white-mobile VisiaPro theme-invitation-animate"
            :style="`margin-bottom: 15px;`"
          >
            UNDANGAN PERNIKAHAN
          </div>
          <h1
            class="fonts fonts-42 fonts-mobile-34 weight-normal white white-mobile Gistesy theme-invitation-animate"
          ...
          <div v-if="guestName" style="margin-top: 15px">
            <div
              class="fonts fonts-14 fonts-mobile-12 white white-mobile VisiaPro capitalize theme-invitation-animate margin margin-bottom-15px"
            >
              Kepada Yth, Bapak/Ibu/Saudara/i :
            </div>
            <div
              class="fonts fonts-18 fonts-mobile-16 white white-mobile VisiaPro capitalize theme-invitation-animate"
            >
              {{ guestName }}
            </div>
            <div
              v-if="guestAddress"
              class="fonts fonts-14 fonts-mobile-12 white white-mobile VisiaPro capitalize theme-invitation-animate"
            >
              {{ guestAddress }}
            </div>
          </div>
        ...
        >
            ...
            <div class="theme-time">
              ...
              >
                <div class="post-middle">
                  <h4
                    class="fonts fonts-28 fonts-mobile-24 white Gistesy"
                    :style="`color: ${primaryColor};`"
                  >
                    {{ days }}
                  </h4>
                  <p class="fonts fonts-14 fonts-mobile-12 white VisiaPro">
                    Hari
                  </p>
                </div>
              </div>
          ...
          >
            <a
              ...
              target="_blank"
              class="btn btn-main btn-small-radius fonts fonts-11 VisiaPro"
              :style="`border-color: ${primaryColor}; background-color: ${primaryColor}; color: ${mainColor}`"
            >
      ...
      <div class="theme-body theme-container">
        ...
        >
          ...
          <div class="width width-500px width-center width-mobile">
            <div
              class="fonts fonts-14 fonts-mobile-12 VisiaPro theme-invitation-animate margin margin-top-15px"
        ...
        >
          ...
          <div class="theme-single-caption theme-single-position">
            <div class="theme-container theme-single-position-bottom-mobile">
              <h1
                class="fonts fonts-42 fonts-mobile-34 weight-normal Gistesy white-mobile text-shadow-mobile theme-invitation-animate"
                :style="`color: ${mainColor};`"
              >
                {{ dt.bride.name }}
              </h1>
              <div
                class="fonts fonts-14 fonts-mobile-12 black white-mobile VisiaPro text-shadow-mobile theme-invitation-animate"
      ...
      <div class="theme-background-white">
        <div class="theme-body theme-container">
          ...
          <div class="theme-padding theme-container" style="padding-bottom: 0">
            <div class="width width-500px width-center width-mobile">
              <div
                class="fonts fonts-14 fonts-mobile-12 grey VisiaPro align-center theme-invitation-animate"
              >
