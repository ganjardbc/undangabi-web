<template>
  <div id="App" class="theme" :style="`background-color: ${backgroundColor};`">
    ...
    >
      ...
      />
      <div v-if="visibleCover" class="theme-cover-left"></div>
      <div v-if="visibleCover" class="theme-cover-right">
      ...
      <div class="theme-single-caption">
        <div class="theme-container post-center-absolute">
          <div
            :class="`fonts fonts-14 fonts-mobile-12 black ${visibleCover ? 'white-mobile' : ''} Lora theme-invitation-animate`"
            :style="`margin-bottom: 15px;`"
          >
            UNDANGAN PERNIKAHAN
          </div>
          <h1
            :class="`fonts fonts-42 fonts-mobile-34 weight-normal black ${visibleCover ? 'white-mobile' : ''} Gistesy theme-invitation-animate`"
          ...
          <div v-if="guestName" style="margin-top: 15px">
            <div
              :class="`fonts fonts-14 fonts-mobile-12 black ${visibleCover ? 'white-mobile' : ''} Lora capitalize theme-invitation-animate margin margin-bottom-15px`"
            >
              Kepada Yth, Bapak/Ibu/Saudara/i :
            </div>
            <div
              :class="`fonts fonts-18 fonts-mobile-16 black ${visibleCover ? 'white-mobile' : ''} Lora capitalize theme-invitation-animate`"
            >
              {{ guestName }}
            </div>
            <div
              v-if="guestAddress"
              :class="`fonts fonts-14 fonts-mobile-12 black ${visibleCover ? 'white-mobile' : ''} Lora capitalize theme-invitation-animate`"
            >
              {{ guestAddress }}
            </div>
          </div>
    ...
    <div class="theme-counter-container">
      <div class="theme-counter-content" id="lavender-countdown">
        <div
        ...
        >
            ...
            <div class="theme-time">
              ...
              >
                <div class="post-middle">
                  ...
                  <p class="fonts fonts-14 fonts-mobile-12 black Lora">Hari</p>
                </div>
              </div>
              <div
                class="time-2 theme-invitation-animate"
              ...
              >
                <div class="post-middle">
                  ...
                  <p class="fonts fonts-14 fonts-mobile-12 black Lora">Jam</p>
                </div>
              </div>
              <div
                class="time-2 theme-invitation-animate"
              ...
              >
                <div class="post-middle">
                  ...
                  <p class="fonts fonts-14 fonts-mobile-12 black Lora">Menit</p>
                </div>
              </div>
              <div
                class="time-2 theme-invitation-animate"
              ...
              >
                <div class="post-middle">
                  ...
                  <p class="fonts fonts-14 fonts-mobile-12 black Lora">Detik</p>
                </div>
              </div>
            </div>
          </VueCountdown>
          ...
          >
            <a
              ...
              :style="`border-color: ${primaryColor}; background-color: ${primaryColor}; color: ${whiteColor}`"
            >
    ...
    <div class="theme-background-white" id="lavender-bride">
      <div v-for="(dt, i) in dataBrides" :key="i" class="width width-100">
        <div
          :class="`
            ${dt.bride.image ? 'theme-header theme-cover-flex theme-cover-profile' : ''}
            ${i % 2 === 0 ? 'row-reverse' : ''}
          `"
        >
          <div v-if="dt.bride.image" class="theme-cover-left"></div>
          <div v-if="dt.bride.image" class="theme-cover-right">
            <div class="theme-cover">
              <div
          ...
          <div
            :class="
              dt.bride.image
                ? `theme-single-caption theme-single-position`
                : `padding padding-top-30px padding-bottom-30px`
            "
          >
            <div class="theme-container theme-single-position-bottom-mobile">
              <h1
                class="fonts fonts-42 fonts-mobile-34 weight-normal black Gistesy theme-invitation-animate"
                :class="{
                  'white-mobile': dt.bride.image,
                  'text-shadow-mobile': dt.bride.image,
                  'align-center': !dt.bride.image,
                }"
                :style="`color: ${primaryColor};`"
              >
                {{ dt.bride.name }}
              ...
              <div
                ...
                :class="{
                  'margin margin-top-15px': !dt.bride.image,
                }"
              >
                <a
    ...
    <div v-if="visibleMap" class="theme-background-white" id="lavender-map">
...
export default {
  ...
  computed: {
    ...
    visibleCover() {
      return (
        this.selectedData &&
        (this.selectedData.invitation.cover || this.dataCovers.length > 0)
      )
    },
  },
  components: {
