<template>
  <div id="App">
    <div
      :class="`display-popup bg-black bg-image theme-greeting-popup ${visible ? 'show' : 'hide'}`"
        ...
        <div class="theme-greeting-cover bottom-fixed">
          ...
          >
            <div class="theme-greeting-left">
              <div
                :class="`fonts fonts-14 fonts-mobile-12 white center normal ${customPrimaryFont}`"
              >
                THE WEDDING OF
              </div>
              <h1
                :class="`fonts fonts-34 fonts-mobile-28 white center weight-normal ${customMainFont}`"
              ...
              <div v-if="guestName" class="margin margin-top-10px">
                <div
                  :class="`fonts fonts-14 fonts-mobile-12 white center capitalize normal ${customPrimaryFont}`"
            ...
            <div class="theme-greeting-right">
              <button
                @click="onClick"
                :class="`btn btn-main fonts fonts-12 ${customPrimaryFont}`"
