<template>
  ...
  >
    <div class="theme-body">
      <div class="theme-header full" id="traditional-redgold-theme-header">
        <div v-if="selectedData" class="theme-cover">
          ...
          <div class="theme-transparent bg-5"></div>

          <div class="post-middle-absolute content-center" style="width: 100%">
            <div class="padding padding-bottom-15px">
              <div
                class="image image-200px image-center bg-transparent theme-invitation-animate"
                style="height: 127px"
              >
            ...
            <h1
              class="fonts fonts-28 fonts-mobile-22 weight-normal ViaodaLibre text-shadow theme-invitation-animate"
              :style="`color: ${mainColor}; line-height: 1.3; margin-top: 10px; margin-bottom: 10px;`"
            >
              {{ selectedData.invitation.title }}
            </h1>
            <div v-if="guestName">
              <div
                class="fonts fonts-14 fonts-mobile-12 white center capitalize normal VisiaPro text-shadow theme-invitation-animate"
                :style="`color: #fff; margin-bottom: 5px; margin-top: 10px;`"
              >
                Kepada
              </div>
              <div
                class="fonts fonts-16 fonts-mobile-14 white center capitalize normal VisiaPro text-shadow theme-invitation-animate"
                :style="`color: #fff;`"
              >
                {{ guestName }}
              </div>
        ...
        <div style="position: absolute; left: 0; bottom: 0; width: 100%">
          <div
            class="image image-80px image-center bg-transparent"
            style="height: 57px"
          >
      ...
      <div
        id="traditional-redgold-theme-bride"
        class="theme-body"
        ...
        <div class="theme-container">
          ...
          >
            <div class="theme-padding">
              <div class="padding padding-bottom-15px theme-invitation-animate">
                <div
                  class="image image-100px image-center bg-transparent"
                  style="height: 42px"
                >
                  <img
                    src="/images/traditional/cream/top-border-black.png"
                    alt=""
                  />
                </div>
              </div>
              ...
              >
                <div
                  class="fonts fonts-22 fonts-mobile-18 black ViaodaLibre theme-invitation-animate"
                  :style="`color: ${primaryColor}; margin-bottom: 10px;`"
                >
                  Assalamu`alaikum Warahmatullaahi Wabarakaatuh
                </div>
                <div
                  v-if="!visibleGreetingQuotes"
          ...
          >
            ...
            >
              <div class="witdth width-100 content-center">
                <div
                  v-if="dt.bride.image"
                ...
                >
                  <div>
                    <h2
                      class="fonts fonts-22 fonts-mobile-18 black ViaodaLibre weight-normal theme-invitation-animate"
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                      class="btn btn-sekunder btn-small-radius traditional-redgold-button-date-content fonts fonts-12 VisiaPro"
                    >
      ...
      <div class="theme-body">
        <AppImageBorder
          ...
          customWidth="100px"
          :enableSizeMobile="false"
          customImageTopLeft="/images/traditional/cream/left-top-border.png"
        />
        <AppImageBorder
          position="top-right"
          scaleX="1"
          customWidth="100px"
          :enableSizeMobile="false"
          customImageTopRight="/images/traditional/cream/right-top-border.png"
        />
      </div>

      <div
        id="traditional-redgold-theme-countdown"
      ...
      >
        <div class="theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              ...
              style="height: 42px"
            >
              <img src="/images/traditional/cream/top-border.png" alt="" />
            </div>
          </div>
          <div style="text-align: center">
            ...
            <div
              class="fonts fonts-14 fonts-mobile-12 white VisiaPro theme-invitation-animate"
            >
          ...
          <div class="theme-time">
            ...
            >
              <div class="post-middle">
                <h4
                  class="fonts fonts-28 fonts-mobile-22 black ViaodaLibre"
                  :style="`color: ${primaryColor};`"
                >
                  {{ days }}
                </h4>
                <p class="fonts fonts-14 fonts-mobile-12 black VisiaPro">
                  Hari
                </p>
              </div>
            </div>
            ...
            >
              <div class="post-middle">
                ...
                <p class="fonts fonts-14 fonts-mobile-12 black VisiaPro">Jam</p>
              </div>
            </div>
            <div
              class="time-2 theme-invitation-animate"
        ...
        >
          <a
            ...
            target="_blank"
            class="btn btn-main traditional-redgold-button-date-reverse fonts fonts-12 VisiaPro"
          >
      ...
      <div
        v-if="visibleEvent"
        id="traditional-redgold-theme-ceremony"
      ...
      <div
        v-if="visibleMap"
        id="traditional-redgold-theme-map"
        class="theme-container"
      >
        <div class="theme-body theme-padding" style="padding-bottom: 0">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
              style="height: 42px"
      ...
      <div
        v-if="visibleLoveStory"
        id="javanese-theme-ceremony"
        class="theme-container"
      >
        <div class="theme-body theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
      ...
      <div
        v-if="visibleGallery"
        id="traditional-redgold-theme-moment"
        class="theme-container"
      >
        <div class="theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
      ...
      <div v-if="visibleVideo" class="theme-body">
        <div class="theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
          ...
          <div
            class="padding padding-left-15px padding-right-15px theme-invitation-animate"
          >
            <div
      ...
      <div class="theme-body" style="padding-top: 60px">
        <AppImageBorder
          position="bottom-left"
          scaleX="1"
          customWidth="100px"
      ...
      <div
        id="traditional-redgold-theme-guest"
        class="theme-body"
        :style="`background-color: ${mainColor};`"
      >
        <div class="theme-container theme-padding" style="padding-bottom: 0">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
              style="height: 42px"
        ...
        <div class="theme-container theme-invitation-animate-disable">
          <AppReservation
            innerClass="width width-100"
            :backgroundChatColor="mainColor"
        ...
        <div v-if="visibleComment" class="theme-container theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
              style="height: 42px"
      ...
      <div v-if="visibleSpecialThanks" class="theme-container">
        <div class="theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
      ...
      <div v-if="visibleNote" class="theme-container">
        <div class="theme-body theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
      ...
      <div v-if="selectedData" class="theme-container">
        <div class="theme-container-small theme-padding">
          <div class="padding padding-bottom-15px theme-invitation-animate">
            <div
              class="image image-100px image-center bg-transparent"
              style="height: 42px"
          ...
          <div class="width width-100 width-center content-center">
            ...
            <div style="padding-top: 10px">
              <h2
                class="fonts fonts-28 fonts-mobile-22 weight-normal ViaodaLibre theme-invitation-animate"
                :style="`color: ${mainColor};`"
              >
                {{ selectedData.invitation.title }}
              </h2>
          ...
          <div class="theme-body">
            ...
            >
              ...
              ></div>
              <div
                class="fonts fonts-22 fonts-mobile-18 white ViaodaLibre theme-invitation-animate"
                :style="`color: ${mainColor};`"
              >
    ...
    >
      ...
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-redgold-theme-countdown')"
      >
        <i class="fa fa-lg fa-clock" :style="`color: ${primaryColor};`"></i>
      </button>
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-redgold-theme-ceremony')"
      >
        <i
      ...
      <button
        ...
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-redgold-theme-map')"
      >
        <i
      ...
      <button
        ...
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-redgold-theme-moment')"
      >
      ...
      <button
        class="btn btn-icon btn-sekunder btn-small-radius"
        :style="`background-color: ${mainColor}; border-color: rgba(0, 0, 0, 0);`"
        @click="scrollToTarget('traditional-redgold-theme-guest')"
      >
        <i
...
export default {
  ...
  methods: {
    closeGuestGreeting() {
      ...
      this.scrollToTarget('traditional-redgold-theme-header')
      this.playAudio()
    },
    playAudio() {
      this.audio.play()
