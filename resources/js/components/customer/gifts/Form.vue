      ...
      <div class="width width-100">
        ...
        <div class="padding padding-bottom-5px">
          <div class="fonts fonts-11 semibold black">
            ID Kado Digital <span class="fonts red">*</span>
          </div>
          <el-input
            ...
            :disabled="true"
          ></el-input>
          <div v-if="formMessage.comment_id" class="fonts fonts-12px red">
            {{ formMessage.comment_id[0] }}
          </div>
        </div>
        <div class="padding padding-top-10px padding-bottom-5px">
          <div class="fonts fonts-11 semibold black">
            Nama Bank / Wallet <span class="fonts red">*</span>
          </div>
          <el-input
        ...
        <div class="padding padding-top-10px padding-bottom-5px">
          <div class="fonts fonts-11 semibold black">
            No. Rekening / No. Handphone <span class="fonts red">*</span>
          </div>
          <el-input
            ...
            :disabled="!visibleSaveButton"
          ></el-input>
          <div v-if="formMessage.comment" class="fonts fonts-12px red">
