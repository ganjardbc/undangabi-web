...
export default {
  ...
  methods: {
    ...
    async removeData() {
      ...
      const rest = await axios.post('/api/productToping/delete', payload, {
    ...
    async saveData() {
      ...
      const payload = {
        ...this.payload,
        toping_id: this.selectedTopingID,
    ...
    async getData(id) {
      ...
      const rest = await axios.post('/api/productToping/getAll', payload, {
        headers: { Authorization: token },
      })
