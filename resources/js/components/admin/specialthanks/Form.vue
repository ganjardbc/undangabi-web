  ...
  <div id="form">
    ...
    >
      ...
      <div v-if="selectedIndex === 0">
        ...
        <div class="field-group margin margin-bottom-15-px">
          <div class="field-label">SPECIAL THANKS ID</div>
          <input
            type="text"
            placeholder=""
            class="field field-sekunder"
            name="specialthanks_id"
            id="specialthanks_id"
        ...
        <div class="field-group margin margin-bottom-15-px">
          ...
          <div
            ...
            style="color: red; margin-top: 5px"
          >
            {{ formMessage && formMessage.icon && formMessage.icon[0] }}
          </div>
        </div>
        ...
        <div class="field-group margin margin-bottom-15-px">
          ...
          <div class="display-flex space-between">
            <div class="fonts micro black">Is this event still available ?</div>
  ...
  watch: {
    data: function (props, prevProps) {
      if (props) {
        this.formData = {
          ...this.formData,
          id: props.specialthanks.id,
          specialthanks_id: props.specialthanks.specialthanks_id,
          name: props.specialthanks.name,
          link: props.specialthanks.link,
          icon: props.specialthanks.icon,
          status: props.specialthanks.status,
          is_available: props.specialthanks.is_available,
          invitation_id: props.specialthanks.invitation_id,
        }
        this.image = props.specialthanks.image
          ? this.specialthankImageThumbnailUrl + props.specialthanks.image
          : ''
