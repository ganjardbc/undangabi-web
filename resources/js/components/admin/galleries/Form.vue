  ...
  <div id="form">
    ...
    >
      ...
      <div v-if="selectedIndex === 0">
        ...
        <div class="field-group margin margin-bottom-15-px">
          <div class="field-label">Gallery ID</div>
          <input
            type="text"
            placeholder=""
            class="field field-sekunder"
          ...
          >
            {{
              formMessage && formMessage.gallery_id && formMessage.gallery_id[0]
            }}
          </div>
        </div>
        <div class="field-group margin margin-bottom-15-px">
        ...
        <div class="field-group margin margin-bottom-15-px">
          <div class="field-label">Tag (only put one tag without space)</div>
          <input
            type="text"
            placeholder=""
            class="field field-sekunder"
    ...
    data: function (props, prevProps) {
      if (props) {
        this.formData = {
          ...this.formData,
          id: props.gallery.id,
          gallery_id: props.gallery.gallery_id,
          description: props.gallery.description,
          tag: props.gallery.tag,
          status: props.gallery.status,
          is_available: props.gallery.is_available,
          invitation_id: props.gallery.invitation_id,
        }
        this.image = props.gallery.image
          ? this.galleryImageThumbnailUrl + props.gallery.image
          : ''
